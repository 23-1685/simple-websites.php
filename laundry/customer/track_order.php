    ...
    <div class="col-lg-8 col-md-10">
        <div class="card card-custom p-4 mb-4">
            <div class="d-flex align-items-center mb-4">
                ...
                <div>
                    <h3 class="fw-bold mb-0">Track Your Order</h3>
                    <p class="text-muted mb-0">Enter your order reference number below to check progress</p>
                </div>
            </div>

            <form method="POST" action="track_order.php" class="row g-2">
                <div class="col-sm-9">
                    <input type="text" name="order" class="form-control form-control-lg" placeholder="e.g. AM1718000000" value="<?= htmlspecialchars($orderNo) ?>" required style="border-radius: 10px;">
                </div>
                <div class="col-sm-3">
                    <button type="submit" name="track" class="btn btn-warning btn-lg w-100 fw-semibold text-dark" style="border-radius: 10px;">
                        Track Now
                    </button>
                </div>
            </form>
        ...
        <?php if ($searched): ?>
                ...
                <div class="card card-custom p-4 p-md-5">
                    ...
                    <?php if ($status == 'cancelled'): ?>
                        <div class="alert alert-danger text-center py-4 rounded-3" role="alert">
                            ...
                            <p class="mb-0 small">This order has been cancelled. Please contact customer care for more information.</p>
                        </div>
                    <?php else: ?>
                        <!-- Visual Timeline -->
            ...
            <?php else: ?>
                <div class="card card-custom p-5 text-center text-muted">
                    ...
                    <p class="mb-0 small">Please double-check the order number (e.g. AM1718000000) and try again.</p>
                </div>
            <?php endif; ?>
        <?php endif; ?>
    </div>
